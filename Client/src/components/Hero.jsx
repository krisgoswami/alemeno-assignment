			...
			<div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 z-10 relative">
				...
				<form className="w-full max-w-md mx-auto">
					...
					<div className="relative">
						...
						<button
							type="submit"
							className="text-white absolute end-2.5 bottom-2.5 bg-blue-500 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-white dark:hover:bg-gray-200 dark:text-gray-800 dark:focus:ring-blue-800"
						>
							Sign up
						</button>
					</div>
